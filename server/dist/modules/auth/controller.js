...
import { loginUser, logoutUser, refreshTokenService, registerUser, } from "./service.js";
...
export const register = asyncHandler(async (req, res) => {
    ...
    return sendResponse(res, StatusCodes.CREATED, "User created successfully", user);
});
