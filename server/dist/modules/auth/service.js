...
import { comparePassword, generateAccessToken, generateJti, generateRefreshToken, hashPassword, hashToken, redisKeys, } from "./utils.js";
...
export const logoutUser = async (decodedToken, exp) => {
...
export const refreshTokenService = async (refreshToken) => {
    ...
    if (session.revokedAt) {
        ...
        throw new ApiError(StatusCodes.UNAUTHORIZED, "Session compromise detected. Please login again.");
    }
